...
class guonei(unittest.TestCase):
    def setUp(self):
    ...
    def test_(self):
        ...
        driver.find_element_by_xpath("//li[5]/div/div/div/div/ul/li/a/p").click()
        driver.find_element_by_xpath("(//cite[@name='citeP'])[2]").click()
        driver.find_element_by_link_text(u"98元/2年").click()
        ...
        driver.find_element_by_css_selector("a.hyzx-head-logo.pull-left").click()
        driver.find_element_by_xpath("//li[5]/div/div/div/div/ul/li[2]/a/h5").click()
