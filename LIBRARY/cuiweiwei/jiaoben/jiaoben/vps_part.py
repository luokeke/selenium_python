...
#open_excel(file=denglufile,a=1,b=0) a-1=行数，b-1=列数
class vps():
...
#                                购买
#========================================================================
    def goumai(self,driver,vpsfile):
        #vpsfile = 'F:\\flie\\vps.xls'
        #driver = webdriver.Firefox()
        #gmlx = "快云vps郑州机房普及型"  # 举例快云vps郑州机房经济型,
        gmsc = open_excel(file=vpsfile,a=1,b=3) # 1m,1y月年
        czxt = open_excel(file=vpsfile,a=1,b=5) # Windows2003,CentOS 6.7,Windows2008-未激活         使用时请复制后面三种类型
        gmlx = open_excel(file=vpsfile,a=1,b=4) # 举例快云vps郑州机房经济型,
...
#===================================================================================================================
    ...
    def xufei(self,driver,vpsfile):
        #vpsfile = 'F:\\flie\\vps.xls'
        #driver = webdriver.Firefox()
        ywbs = open_excel(file=vpsfile,a=10,b=1)
        #gongneng = "升级"
        xfsc = open_excel(file=vpsfile,a=10,b=3)
        #sjpz = "旗舰型"
        lb = open_excel(file=vpsfile,a=10,b=4)
        ...
        sleep(3)
        driver.find_element_by_xpath("html/body/div[3]/div[2]/div/div[2]/div[2]/form/div/input[3]").send_keys(ywbs)
        ...
        #if gongneng == "续费":
        driver.find_element_by_link_text("续费").click()
        sleep(2)
...
#==================================================================================================
    ...
    def shengji(self, driver,vpsfile):
        #vpsfile = 'F:\\flie\\vps.xls'
        # driver = webdriver.Firefox()
        ywbs = open_excel(file=vpsfile,a=20,b=1)
        #gongneng = "升级"

        sjpz = open_excel(file=vpsfile,a=20,b=3)
        lb = open_excel(file=vpsfile,a=20,b=4)
        driver.get("https://mc.kuaiyun.cn/vps/list?vpsbb=2&istm=false")
        if "香港VPS" in lb:
            driver.find_element_by_link_text(u"香港VPS").click()
        elif lb == "云VPS":
        ...
        sleep(1)
        driver.find_element_by_xpath("(//input[@value=''])[3]").click()
        driver.find_element_by_link_text("升级").click()
...
#================================================================================================
    def zhuanzheng(self, driver,vpsfile):
        #vpsfile = 'F:\\flie\\vps.xls'
        # driver = webdriver.Firefox()
        ywbs = open_excel(file=vpsfile,a=30,b=1)
        #gongneng = "转正"
        kyb=open_excel(file=vpsfile,a=30,b=2)
        zzsc=open_excel(file=vpsfile,a=30,b=3)
        lb = open_excel(file=vpsfile,a=30,b=4)
        driver.get("https://mc.kuaiyun.cn/vps/list?vpsbb=2&istm=false")
        if "香港VPS" in lb:
            driver.find_element_by_link_text(u"香港VPS").click()
        elif lb == "云VPS":
        ...
        driver.find_element_by_link_text("转正").click()

        sleep(2)
        #driver.find_element_by_css_selector("input.bk-disk-input").clear()
        driver.find_element_by_css_selector("input.bk-disk-input").send_keys(zzsc)
        driver.find_element_by_id("kyb_input").clear()
...
#=====================================================================================================
    ...
    def linshizengzhi(self, driver,vpsfile):
        #vpsfile = 'F:\\flie\\vps.xls'
        # driver = webdriver.Firefox()
        ywbs = open_excel(file=vpsfile,a=40,b=1)
        #gongneng = "临时增值"
        kyb = open_excel(file=vpsfile,a=40,b=2)
       # xfsc = "2017-11-01"
        lb = open_excel(file=vpsfile,a=40,b=4)
        xuanze=open_excel(file=vpsfile,a=40,b=5)
        yplx=open_excel(file=vpsfile,a=40,b=6)#硬盘类型   u"容量型"   u"标准型"    u"性能型"
        ypdx=open_excel(file=vpsfile,a=40,b=7)    #硬盘大小
        i=0
        daikuan=open_excel(file=vpsfile,a=40,b=8)#所需升级带宽
        driver.get("https://mc.kuaiyun.cn/vps/list?vpsbb=2&istm=false")
        if "香港VPS" in lb:
            driver.find_element_by_link_text(u"香港VPS").click()
        elif lb == "云VPS":
        ...
        driver.find_element_by_link_text("临时增值").click()
#======================================
...
#=======================================================================================================================
    def fuwuma(self,driver,vpsfile):
        driver.find_element_by_link_text("业务服务码").click()


    def guzhangshenbao(self, driver,vpsfile):
        driver.find_element_by_link_text("故障申报").click()

    def rizhi(self,driver,vpsfile):
