...
if zhuceleixing == 11:
    ...
    driver.get("https://www.zzidc.com/chengxinjie.htm")
...
if zhuceleixing != 21:
    # 两个定位都可以
    #driver.find_element_by_xpath("//form[@id='register_form']/div[10]/div[2]/div[2]/div[1]/span").click()
